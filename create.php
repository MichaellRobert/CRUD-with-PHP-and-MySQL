    ...
    <div class="container">
      ...
      <form action="tambah.php" method="post">
        ...
        <div class="mb-3">
          ...
          <input name="class" type="text" class="form-control" id="exampleInputText1" >
        </div>
        <div class="mb-3">
          <label for="exampleInputText1" class="form-label">NIM</label>
          <input name="nim" type="text" class="form-control" id="exampleInputText1" >
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input name="phone" type="text" class="form-control" id="exampleInputText1" >
        </div>
